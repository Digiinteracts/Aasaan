...
public class MyReviewAdapter extends ArrayAdapter<String> {
    ...
    public MyReviewAdapter(Activity context, String[] names, String[] desc, Integer[] imageid) {
        super(context, R.layout.myreview_item, names);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.myreview_item, null, true);
